...
namespace CleanArchitecture.Infrastructure.Migrations
{
    ...
    [Migration("20240806102149_OutboxCreationMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Alquileres.Alquiler", b =>
                {
                    ...
                    b.Property<int>("AlquilerStatus")
                        .HasColumnType("integer")
                        .HasColumnName("alquiler_status");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Permisions.Permission", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasIndex("VeiculoId")
                        .HasDatabaseName("ix_reviews_veiculo_id");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Roles.RolePermission", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Permisions.Permission", null)
                        .WithMany()
